  ...
  return (
    <section className="grid gap-3">
      <form action={formAction} className="grid gap-3 sm:grid-cols-[1fr_auto]">
        ...
        <button className="neon-action mt-7 min-h-12 px-4 font-black uppercase disabled:opacity-50" disabled={pending}>
      ...
      {state ? (
        <div className="grid gap-2 border border-[#B45CFF]/35 bg-black/25 p-3 text-sm">
          ...
          <p>Inscricoes confirmadas: <strong className="text-[#A855F7]">{state.confirmed}</strong></p>
